...
def is_email_available(username = None):
...
@transaction.atomic
def create_inactive_user(username=None, email=None, password=None, firstname = None, lastname = None):
    user_model = get_user_model()
...
def send_activation_email(user, site):
    ...
    """
    ctx_dict = {'activation_key': user.reguser.activation_key,
